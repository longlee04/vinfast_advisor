...
Làm ba việc: cơ hội im > 30 ngày → DORMANT; phiên idle > 30 phút chưa được gắn/đánh giá
tới lượt cuối → gắn cơ hội (chỉ khách có cờ `customer360_attach`); tính lại độ nóng (điểm
giảm theo thời gian). Task nền trong process API mất khi restart thì chính script này nhặt lại.
"""
